...
#LIBRARY=$1 #e.g. ISR
#RUN=$2 #e.g. 21121
R-3.3.0 CMD BATCH --vanilla '--args module="tximport" pathToDir="/lustre/scratch115/projects/paxgene/SalmonOutput_newruns/IU_21364_sorted/"  pathTosampleFile="/lustre/scratch115/projects/paxgene/SalmonOutput_newruns/IU_21364_sorted.list" typeOfTranscript="salmon" t2g="transcripts2gene.index" output="/lustre/scratch115/projects/paxgene/SalmonOutput_newruns/IU_21364_sorted.transcript_to_gene.counts" typeMatrix="counts"' /lustre/scratch115/projects/paxgene/rnaseq.generalTools.WithArguments.R /lustre/scratch115/projects/paxgene/rnaseq.generalTools.WithArguments.Rout
